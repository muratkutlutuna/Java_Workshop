...
public class ArabaMain {
	public static void main(String[] args) {
		...
		System.out.println("sectiginiz arac volvo -> " + "yili : " + volvo.getYil() + " renk : " + volvo.getRenk()
				+ " motor : " + volvo.getMotor());
		System.out.println("sectiginiz arac ww -> " + "yili : " + ww.getYil() + " renk : " + ww.getRenk() + " motor : "
				+ ww.getMotor());
